...
<body class="min-h-screen flex flex-col antialiased selection:bg-ciano/20 selection:text-ciano">
  ...
  <main class="flex-grow pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
    ...
    <!-- BOTTOM COMMUNITY CALLOUT (CTA) -->
    <div class="mt-20 glass rounded-2xl p-8 sm:p-10 text-center border border-ouro/20 bg-gradient-to-br from-ouro/5 via-transparent to-ciano/5 relative overflow-hidden shadow-2xl">
      <div class="relative z-10 max-w-2xl mx-auto">
        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-wider text-ouro bg-ouro/10 border border-ouro/20 mb-3">
          <i data-lucide="sparkles" class="w-3.5 h-3.5"></i>
          Comunidade Inteligência Agêntica
        </span>
        <h3 class="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-3">
          Quer instalar e liderar agentes na sua empresa?
        </h3>
        ...
        <a href="/#oferta" class="btn-gold px-7 py-3.5 rounded-xl text-xs sm:text-sm font-bold tracking-wide inline-flex items-center gap-2 shadow-lg shadow-ouro/20">
  ...
  <footer class="border-t border-white/5 py-12 bg-obsidian-light/50 mt-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p class="text-[11px] text-gray-500">&copy; 2026 Inteligência Agêntica &bull; JePierre Soluções. Todos os direitos reservados.</p>
